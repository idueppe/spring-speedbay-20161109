...
public class ApplicationLogRepositoryBean extends NamedParameterJdbcDaoSupport implements ApplicationLogRepository {
    ...
    public static final String INSERT_SQL = "INSERT INTO APPLICATION_LOG (id, message, createdAt, createdBy) VALUES (nextVal('AppLogSequence'), :message, :createdAt, :createdBy)";
